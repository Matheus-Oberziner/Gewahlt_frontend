<template>
  ...
  <q-card
    v-if="type === 'type5'"
    style="border-radius: 30px; min-width: 70%;"
    class="shadow_bottom"
  >
    <q-card-section class="no-padding">
      <div class="col-12 row">
        <div class="row items-center text-blue q-py-sm q-px-lg q-gutter-md" style="background-color: #F3F3F3; border-bottom-right-radius: 10px;">
